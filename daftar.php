        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    ...
                    <p class="text-muted text-center">Silahkan Daftar ke Peduli Diri.</p>

                    <form class="form-horizontal m-t-30" method="post">

                        <div class="form-group">
                            <label for="useremail">NIK</label>
                            <input type="text" name="nik" class="form-control" id="useremail" >
                        </div>
                        ...
                        <div class="form-group row m-t-20">
                            <div class="col-12 text-right">
                                <button name="daftar" class="btn btn-primary w-md waves-effect waves-light" type="submit">Daftar</button>
                            </div>
                        </div>

                        <div class="form-group m-t-5 mb-0 row">
                            <div class="col-12 m-t-5">
                                <p class="text-muted">Sudah Mempunyai Akun ? <a href="login.php" class="text-black"> Masuk Disini </a> </p>
                            </div>
                        </div>
                    </form>
                    <?php
                    ...
                    if (isset($_POST['daftar'])) 
                    {
                        ...
                        $koneksi->query("INSERT INTO user VALUES('','$username','$nik','$password') ");
